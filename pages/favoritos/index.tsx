...
const FavoritesPage = () => {
  const { favorites, loading } = useUserLists();
  ...
  useEffect(() => {
    if (activeFilter === 'all') {
      ...
      setFilteredItems(favorites.filter(item => item.media_type === activeFilter));
    }
  ...
  return (
    <Layout>
      <Head>
        <title>Meus Favoritos | CineVerso</title>
        <meta name="description" content="Sua lista de filmes e séries favoritos no CineVerso." />
        ...
        <div className="container mx-auto px-6 pt-6">
          <div className="mb-6">
            ...
            <p className="text-gray-400">
              Sua coleção de filmes e séries favoritos no CineVerso.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          {loading ? (
            ...
            <div className="bg-background-alt/50 rounded-xl p-8 text-center">
              <h2 className="text-xl font-bold mb-4">Faça login para ver seus favoritos</h2>
              <p className="text-gray-400 mb-6">
                Você precisa estar logado para adicionar filmes e séries aos seus favoritos.
              </p>
              <Link 
                href="/auth/login"
            ...
            <div className="bg-background-alt/50 rounded-xl p-8 text-center">
              <h2 className="text-xl font-bold mb-4">Sua lista de favoritos está vazia</h2>
              <p className="text-gray-400 mb-6">
                Você ainda não adicionou nenhum {activeFilter === 'movie' ? 'filme' : activeFilter === 'tv' ? 'série' : 'filme ou série'} aos seus favoritos.
              </p>
              <Link 
